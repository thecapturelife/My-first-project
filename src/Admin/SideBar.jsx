...
const SideBar = () => {
  return (
    <div style={{ display: "flex", height: "100vh", overflow: "scroll initial" }}>
      <CDBSidebar textColor="#fff" backgroundColor="linear-gradient(to right, #23074d, #cc5333)">
        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            ...
            <NavLink exact to="/adminaddproduct" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="plus">Add Product</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/adminmain" activeClassName="activeClicked">
